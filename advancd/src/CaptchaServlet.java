 ...
 *
 */
 public class CaptchaServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   ...
   protected void processRequest(HttpServletRequest request,
		   ...
		   final GradientPaint gradientPaint = new GradientPaint(0, 0, Color.black, 0, height / 2,
		   Color.black, true);
