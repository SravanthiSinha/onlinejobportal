			    ...
			    //   }catch (SQLException e) {
				   ...
				   System.out.println("got coonection in request");
					    ...
					    {  PrintWriter out2=response.getWriter();
					    	...
					    	String str=null;
					    	str="SELECT USERS.EMAILID, USERS.USERID FROM SONY.USERS AS USERS WHERE USERS.USERID = 'jobseeker'  ";
					    	System.out.println(str);				    		
							rs= st.executeQuery(str);	Integer i=0;%>
								
	<%while(rs.next()){%>
	<div class="article"><table width="600" align="left" bordercolordark="#6633FF" frame="box" class="altrowstable" id="alternatecolor" ><!--DWLayoutTable-->
	<tbody>	
	<tr>
