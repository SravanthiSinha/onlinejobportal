...
function checkAll(){
if(putTag("fname")&&putTag("lname")&&putTag("email1")&&putTag("pwd1")&&putTag("rpwd")&&putTag("year")&&putTagcompadd("compadd")&&checkCity()&&checkState()&&checkCountry()&&putTagpin_code()&&putTag("mobile")&&putTag("code")&&checkCountrycode()&&putTag("code")&&putTag("mob3")&&putTag("mob4")&&putTagcourse()&&checkUniversity()&&putTaggrade()&&putTagdesg()&&checkCategory()&&checklocation())
{
return true;
}
else{
...
function checkAlle(){
if(putTag("fname")&&putTag("lname")&&putTag("email1")&&putTag("pwd1")&&putTag("rpwd")&&putTag("year")&&putTagcompadd("compadd")&&checkCity()&&checkState()&&checkCountry()&&putTagpin_code()&&putTag("mobile")&&putTag("code")&&checkCountrycode()&&putTag("code")&&putTag("mob3")&&putTag("mob4")&&putTagcomp()&&putTagdesg()&&putTag("c_email"))
{
return true;
}
else{
...
if(document.getElementById("course").value=="")
		{
			...
			document.getElementById("courselab").innerHTML="<label id='courselab'><font face='Calibri' color='#FF0000' size='-1'>Please give company/home your address </font></label>";
			return false;
		}
		else{
			document.getElementById("courselab").style.visibility="visible";
