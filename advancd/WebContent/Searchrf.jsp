...
xmlhttp.open("GET","Searching.jsp?searchfrm="+document.getElementById("searchfrm").value+"&loc="+document.getElementById("loc").value,true);
xmlhttp.send();
}
</script>
</head>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="menubar">
		 ...
		 <tbody >
		 <tr>
         <td width="100%" height="30" valign="middle" class="profileTab"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
		            <tr>
                    <td  class="ss" align="center" valign="middle"><div>
                      <h2><span> Search</span> By Function </h2>
                    </div>
					 </td>
                  	</tr>
                </tbody>
		...
		<input type="hidden" name="searchfrm" value="esf" id="searchfrm" />
...
<input type="hidden" name="searchfrm" value="esf" id="searchfrm" />
		      <table border="0" cellspacing="0" width="100%">
		        ...
		        <tbody><tr>
		          ...
		          <tr>
		            <td></td>
		              <td><input name="fts" size="50" id="fts" value="" type="text"></td>
		    <td></td>
		    </tr>		
		          <tr>
		            <td></td>
		              <td style="padding: 0px 5px 0px 0px;"><table border="0" cellpadding="3" cellspacing="0" width="100%">
		                ...
		                <tr>
		                  <td><select name="loc" size="4" id="loc" multiple="multiple" >
